...
app.listen(process.env.PORT || 5000, async function (err) {
  try {
    await mongoose.connect('mongodb+srv://root:G3YrA9HKolMud0m5@cluster0.fha6ifp.mongodb.net/myFirstDatabase?retryWrites=true&w=majority',{ useNewUrlParser: true, dbName: 'unicorns', useUnifiedTopology: true })
  } catch (error) {
